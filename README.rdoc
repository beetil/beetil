...
*Under Active Development - Use at your own peril*

== Note on Releases

To build from master, you can clone the code, generate the updated gemspec, build the gem and install.

  rake gemspec
  gem build beetil.gemspec
